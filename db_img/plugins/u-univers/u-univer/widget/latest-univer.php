<?php
class Widget_Univer_Listing extends WP_Widget {	

	function __construct() {
    	$widget_ops = array(
			'classname'   => 'event_listing_widget', 
			'description' => __('University - Univers Listing ','cactusthemes')
		);
    	parent::__construct('advanced-latest-event', __('University - Univers Listing ','cactusthemes'), $widget_ops);
	}


	function widget($args, $instance) {
		$cache = wp_cache_get('widget_lastest_univer', 'widget');		
		if ( !is_array($cache) )
			$cache = array();
	...
	function form( $instance ) {
        ...
        <select id="<?php echo $this->get_field_id("sort_by"); ?>" name="<?php echo $this->get_field_name("sort_by"); ?>">
          ...
          <option value="upcoming"<?php selected( $instance["sort_by"], "upcoming" ); ?>>Start Date, Upcoming Univers </option>
          <option value="recent"<?php selected( $instance["sort_by"], "recent" ); ?>>Start Date, Recent Univers </option>
        </select>
        </label>
        </p>
<?php
...
// register widget
add_action( 'widgets_init', create_function( '', 'return register_widget("Widget_Univer_Listing");' ) );
?>